...
public enum Column implements Columnable {
    ...
    public static List<Column> getVisibleColumns() {
        ...
        //иду по значениям массива realOder в поисках нулевого элемента для отображения (если такой есть)
        while (hasNextElement) {
            ...
            //после добавления нулевого или следующего элемента проверяю, если ли в массиве realOrder следующий элемент для отображения
            for (int i = 0; i < realOrder.length; i++) {
