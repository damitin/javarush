...
public class Solution {
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            String staticString = ClassWithStatic.staticString == null ? "null" : ClassWithStatic.staticString;
            printWriter.println(staticString);
            String intI = String.valueOf(i);
            printWriter.println(intI);
            String intJ = String.valueOf(j);
            printWriter.println(intJ);
            printWriter.flush();
        }
